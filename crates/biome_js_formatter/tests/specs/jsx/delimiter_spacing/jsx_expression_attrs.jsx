...
// Test 7: boundary - 76 chars + 4 spaces = 80 (fits on one line)
<Foo a={[aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa]} />;

// Test 8: boundary - 77 chars + 4 spaces = 81 (breaks to multi-line)
<Foo a={[aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa]} />;
...
// Test 8: boundary - 80 chars fits
<Foo a={b + c + d + e + f + g + h + i + j + k + l + m + n + o + p + q + r} />;

// Test 9: boundary - 81 chars breaks element (spaces kept)
<Foo a={b + c + d + e + f + g + h + i + j + k + l + m + n + o + p + q + rr} />;
...
// Test 14: Boundary - 78 chars input + 2 spaces = 80 chars (fits)
<Foo {/* a */ ...bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb} />;

// Test 15: Boundary - 79 chars input + 2 spaces = 81 chars (breaks)
<Foo {/* a */ ...bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb} />;

// Test 16: Line comment (always breaks)
<Foo {
	// a
	...b
} />;
...
// Boundary test: 78 chars input + 2 spaces = 80 chars (fits on one line)
<Foo {...aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa} />;

// Boundary test: 79 chars input + 2 spaces = 81 chars (breaks to multi-line)
<Foo {...aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa} />;
...
// Boundary with conditional - 80 chars
<Foo {...(condition ? aaaaaaaaaaaaaaaaaaaaaaaaaaaaaa : bbbbbbbbbbbbb)} />;

// Boundary with conditional - 81 chars (breaks)
<Foo {...(condition ? aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa : bbbbbbbbbbbbb)} />;
